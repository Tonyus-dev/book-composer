...
const PRODUCTION_ROOT = "/home/tonyus-dev/Downloads/CURADORIA_DE_CONTEUDO/agora_sim_producao/PRODUCAO";
...
const APPROVED_HISTORIA_PROJECT = path.join(ROOT, "projects", "kallistis-materializado-historia-v5.json");
const APPROVED_AGGREGATE_PROJECT = path.join(ROOT, "projects", "kallistis-materializado-partes-i-iv-v1.json");
...
const SEMANTIC_ASSET_RULES = new Map([
  ["Prólogo — A velha e a Fresta", { semanticAnchor: "Prólogo — A velha e a Fresta", allowedHeadingTexts: ["Prólogo — A velha e a Fresta"], allowedWindow: "SAME_H2" }],
  ["PARTE I — O MUNDO PARTIDO", { semanticAnchor: "PARTE I — O MUNDO PARTIDO", allowedHeadingTexts: ["PARTE I — O MUNDO PARTIDO"], allowedWindow: "SAME_H1" }],
  ["Manesh — O Mundo da Luz", { semanticAnchor: "Manesh — O Mundo da Luz", allowedHeadingTexts: ["Manesh — O Mundo da Luz"], allowedWindow: "SAME_H2" }],
  ["Thuvel — O Mundo da Escuridão", { semanticAnchor: "Thuvel — O Mundo da Escuridão", allowedHeadingTexts: ["Thuvel — O Mundo da Escuridão"], allowedWindow: "SAME_H2" }],
  ["Luz, Escuridão e Sombra", { semanticAnchor: "Luz, Escuridão e Sombra / Kav", allowedHeadingTexts: ["Luz, Escuridão e Sombra", "Kav — Sombra É Corrupção, Não Escuridão"], allowedWindow: "ALLOWED_H2S" }],
  ["O Grande Cristal — Antes Que Houvesse Dois Mundos", { semanticAnchor: "O Grande Cristal", allowedHeadingTexts: ["O Grande Cristal — Antes Que Houvesse Dois Mundos"], allowedWindow: "SAME_HEADING_SUBTREE" }],
  ["Mirveth — Uma Pessoa Inteira", { semanticAnchor: "Mirveth", allowedHeadingTexts: ["Mirveth — Uma Pessoa Inteira"], allowedWindow: "SAME_H2" }],
  ["Vethari — Relação Sem Apagamento", { semanticAnchor: "Vethari / contraponto Mirveth", allowedHeadingTexts: ["Vethari — Relação Sem Apagamento"], allowedWindow: "SAME_H2" }],
  ["Pedr’alma", { semanticAnchor: "Pedr’alma", allowedHeadingTexts: ["Pedr’alma"], allowedWindow: "SAME_H2" }],
  ["Lar · Cidade · Companhia", { semanticAnchor: "Lar · Cidade · Companhia", allowedHeadingTexts: ["Lar · Cidade · Companhia"], allowedWindow: "SAME_H2" }],
  ["História do Mundo Partido", { semanticAnchor: "História do Mundo Partido / Dupla Herança / Fratura", allowedHeadingTexts: ["História do Mundo Partido"], allowedWindow: "SAME_H2" }],
  ["A escrita contínua", { semanticAnchor: "Silmain / escrita contínua", allowedHeadingTexts: ["A escrita contínua"], allowedWindow: "SAME_HEADING_SUBTREE" }],
  ["As primeiras frestas controladas", { semanticAnchor: "primeiras Frestas", allowedHeadingTexts: ["As primeiras frestas controladas"], allowedWindow: "SAME_HEADING_SUBTREE" }],
  ["Kethrell e a doutrina da recomposição", { semanticAnchor: "Restauração Científica / Kethrell", allowedHeadingTexts: ["Kethrell e a doutrina da recomposição"], allowedWindow: "SAME_HEADING_SUBTREE" }],
  ["Os Outros", { semanticAnchor: "Os Outros / Lightbringers", allowedHeadingTexts: ["Os Outros", "Os Lightbringers"], allowedWindow: "ALLOWED_HEADINGS" }],
  ["Daeren", { semanticAnchor: "Daeren / Thavin / Isenna", allowedHeadingTexts: ["Daeren", "Thavin", "Isenna e a cisão interna"], allowedWindow: "ALLOWED_HEADINGS" }],
  ["A profecia de Thaeraen", { semanticAnchor: "Thaeraen / Tempo da Escolha", allowedHeadingTexts: ["A profecia de Thaeraen"], allowedWindow: "SAME_HEADING_SUBTREE" }],
  ["PARTE II — O CINTURÃO DAS FRESTAS", { semanticAnchor: "Cinturão das Frestas", allowedHeadingTexts: ["PARTE II — O CINTURÃO DAS FRESTAS"], allowedWindow: "SAME_H1", family: "PART_HERO" }],
  ["PARTE III — POVOS, COMUNIDADES E CAMINHOS", { semanticAnchor: "Povos, Comunidades e Caminhos", allowedHeadingTexts: ["PARTE III — POVOS, COMUNIDADES E CAMINHOS"], allowedWindow: "SAME_H1", family: "PART_HERO" }],
  ["PARTE IV — MEMÓRIA, PEDR’ALMA E FÉ", { semanticAnchor: "Memória, Pedr’alma e Fé", allowedHeadingTexts: ["PARTE IV — MEMÓRIA, PEDR’ALMA E FÉ"], allowedWindow: "SAME_H1", family: "PART_HERO" }],
  ["PARTE V — VELARIM", { semanticAnchor: "Velarim", allowedHeadingTexts: ["PARTE V — VELARIM"], allowedWindow: "SAME_H1", family: "PART_HERO" }],
  ["PARTE VI — JOGANDO KALLISTIS", { semanticAnchor: "Jogando KALLISTIS", allowedHeadingTexts: ["PARTE VI — JOGANDO KALLISTIS"], allowedWindow: "SAME_H1", family: "PART_HERO" }],
  ["PARTE VII — CONDUZINDO KALLISTIS", { semanticAnchor: "Conduzindo KALLISTIS", allowedHeadingTexts: ["PARTE VII — CONDUZINDO KALLISTIS"], allowedWindow: "SAME_H1", family: "PART_HERO" }],
  ["O Mapa em Duas Camadas", { semanticAnchor: "Mapa em Duas Camadas", allowedHeadingTexts: ["O Mapa em Duas Camadas"], allowedWindow: "SAME_H2", family: "MAP_PAGE", preferredFit: "contain" }],
  ["A Fenda de Kethrell", { semanticAnchor: "Fenda de Kethrell", allowedHeadingTexts: ["A Fenda de Kethrell"], allowedWindow: "SAME_H2", family: "GEOGRAPHY_OPENING" }],
  ["Geografia da Luz: Planalto de Silmari", { semanticAnchor: "Planalto de Silmari", allowedHeadingTexts: ["Geografia da Luz: Planalto de Silmari"], allowedWindow: "SAME_H2", family: "GEOGRAPHY_OPENING" }],
  ["Geografia da Escuridão: Vale de Thur-Daer", { semanticAnchor: "Vale de Thur-Daer", allowedHeadingTexts: ["Geografia da Escuridão: Vale de Thur-Daer"], allowedWindow: "SAME_H2", family: "GEOGRAPHY_OPENING" }],
  ["Rotas Oficiais", { semanticAnchor: "Rotas Oficiais", allowedHeadingTexts: ["Rotas Oficiais"], allowedWindow: "SAME_H2", family: "MAP_PAGE", preferredFit: "contain" }],
  ["Rotas Clandestinas e Comércio", { semanticAnchor: "Rotas Clandestinas e Comércio", allowedHeadingTexts: ["Rotas Clandestinas e Comércio"], allowedWindow: "SAME_H2", family: "MAP_PAGE", preferredFit: "contain" }],
  ["O Estado Político Atual", { semanticAnchor: "Estado Político Atual", allowedHeadingTexts: ["O Estado Político Atual"], allowedWindow: "SAME_H2", family: "GEOGRAPHY_OPENING" }],
  ["Tensões Regionais: Aelvari, Kragor, Draken e Nomos", { semanticAnchor: "Tensões Regionais — primeira camada", allowedHeadingTexts: ["Tensões Regionais: Aelvari, Kragor, Draken e Nomos"], allowedWindow: "SAME_H2", family: "TENSION_OPENING", preferredFit: "contain" }],
  ["Tensões Regionais: Livres, Dóreos, Teriantes, Nimari e Vitrálios", { semanticAnchor: "Tensões Regionais — segunda camada", allowedHeadingTexts: ["Tensões Regionais: Livres, Dóreos, Teriantes, Nimari e Vitrálios"], allowedWindow: "SAME_H2", family: "TENSION_CONTINUATION" }],
  ["AELVARI", { semanticAnchor: "Povo Aelvari", allowedHeadingTexts: ["AELVARI"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["KRAGOR", { semanticAnchor: "Povo Kragor", allowedHeadingTexts: ["KRAGOR"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["DRAKEN", { semanticAnchor: "Povo Draken", allowedHeadingTexts: ["DRAKEN"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["NOMOS", { semanticAnchor: "Povo Nomos", allowedHeadingTexts: ["NOMOS"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["LIVRES", { semanticAnchor: "Povo Livres", allowedHeadingTexts: ["LIVRES"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["DÓREOS", { semanticAnchor: "Povo Dóreos", allowedHeadingTexts: ["DÓREOS"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["TERIANTES", { semanticAnchor: "Povo Teriantes", allowedHeadingTexts: ["TERIANTES"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["NIMARI", { semanticAnchor: "Povo Nimari", allowedHeadingTexts: ["NIMARI"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["VITRÁLIOS", { semanticAnchor: "Povo Vitrálios", allowedHeadingTexts: ["VITRÁLIOS"], allowedSectionH2: "NOVE MANEIRAS DE EXISTIR", allowedWindow: "SAME_HEADING_SUBTREE", family: "POVO_OPENING" }],
  ["OITO MANEIRAS DE ESCOLHER", { semanticAnchor: "Ofícios e escolhas", allowedHeadingTexts: ["OITO MANEIRAS DE ESCOLHER"], allowedWindow: "SAME_H2", family: "OFICIO_CULTURAL_OPENING" }],
  ["Definição cultural de Pedr’alma", { semanticAnchor: "Definição cultural de Pedr’alma", allowedHeadingTexts: ["Definição cultural de Pedr’alma"], allowedWindow: "SAME_H2", family: "PEDRALMA_OPENING" }],
  ["Pedra, símbolo e identidade", { semanticAnchor: "Pedra, símbolo e identidade", allowedHeadingTexts: ["Pedra, símbolo e identidade"], allowedWindow: "SAME_H2", family: "PEDRALMA_OPENING" }],
  ["Pedr’almas familiares", { semanticAnchor: "Pedr’almas familiares", allowedHeadingTexts: ["Pedr’almas familiares"], allowedWindow: "SAME_H2", family: "IMAGE_TOP" }],
  ["Pedr’almas de companhia", { semanticAnchor: "Pedr’almas de companhia", allowedHeadingTexts: ["Pedr’almas de companhia"], allowedWindow: "SAME_H2", family: "IMAGE_TOP" }],
  ["A pergunta que atravessa a passagem", { semanticAnchor: "encerramento da Parte IV", allowedHeadingTexts: ["A pergunta que atravessa a passagem"], allowedWindow: "SAME_H2", family: "FINAL_CLOSURE" }],
  ["O QUE É VELARIM", { semanticAnchor: "O que é Velarim", allowedHeadingTexts: ["O QUE É VELARIM"], allowedWindow: "SAME_H2", family: "IMAGE_TOP" }],
  ["Pedr’alma no uso de Velarim", { semanticAnchor: "Pedr’alma no uso de Velarim", allowedHeadingTexts: ["Pedr’alma no uso de Velarim"], allowedWindow: "SAME_H2", family: "IMAGE_TOP" }],
  ["Bestiário do Cristal Partido", { semanticAnchor: "Bestiário do Cristal Partido", allowedHeadingTexts: ["Bestiário do Cristal Partido"], allowedWindow: "SAME_H2", family: "BESTIARY_ENTRY" }],
  ["Drakos — a forma dracônica que não é Povo", { semanticAnchor: "Drakos", allowedHeadingTexts: ["Drakos — a forma dracônica que não é Povo"], allowedWindow: "SAME_H2", family: "BESTIARY_ENTRY" }],
  ["Dragão Cristalino Colossal", { semanticAnchor: "Dragão Cristalino Colossal", allowedHeadingTexts: ["Dragão Cristalino Colossal"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Tartaruga-Fortaleza", { semanticAnchor: "Tartaruga-Fortaleza", allowedHeadingTexts: ["Tartaruga-Fortaleza"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Leviatã dos Veios", { semanticAnchor: "Leviatã dos Veios", allowedHeadingTexts: ["Leviatã dos Veios"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Árvore-Mãe Errante", { semanticAnchor: "Árvore-Mãe Errante", allowedHeadingTexts: ["Árvore-Mãe Errante"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Estilhaço Vitrálio Instável", { semanticAnchor: "Estilhaço Vitrálio Instável", allowedHeadingTexts: ["Estilhaço Vitrálio Instável"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Corvo de Fresta", { semanticAnchor: "Corvo de Fresta", allowedHeadingTexts: ["Corvo de Fresta"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Filhote de Tormenta", { semanticAnchor: "Filhote de Tormenta", allowedHeadingTexts: ["Filhote de Tormenta"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Autômato de Ponte Descontrolado", { semanticAnchor: "Autômato de Ponte Descontrolado", allowedHeadingTexts: ["Autômato de Ponte Descontrolado"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Eco Corrompido", { semanticAnchor: "Eco Corrompido", allowedHeadingTexts: ["Eco Corrompido"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Serpente do Leito Escrito", { semanticAnchor: "Serpente do Leito Escrito", allowedHeadingTexts: ["Serpente do Leito Escrito"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Cão-Leão das Brasas Errantes", { semanticAnchor: "Cão-Leão das Brasas Errantes", allowedHeadingTexts: ["Cão-Leão das Brasas Errantes"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Pato de Pressão Ressonante", { semanticAnchor: "Pato de Pressão Ressonante", allowedHeadingTexts: ["Pato de Pressão Ressonante"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Roedor dos Veios Fulminantes", { semanticAnchor: "Roedor dos Veios Fulminantes", allowedHeadingTexts: ["Roedor dos Veios Fulminantes"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Devorador Psíquico Cefalóide", { semanticAnchor: "Devorador Psíquico Cefalóide", allowedHeadingTexts: ["Devorador Psíquico Cefalóide"], allowedWindow: "SAME_HEADING_SUBTREE", family: "BESTIARY_ENTRY" }],
  ["Guardião", { semanticAnchor: "Ofício Guardião", allowedHeadingTexts: ["Guardião"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Duelista", { semanticAnchor: "Ofício Duelista", allowedHeadingTexts: ["Duelista"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Atirador", { semanticAnchor: "Ofício Atirador", allowedHeadingTexts: ["Atirador"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Tecelão", { semanticAnchor: "Ofício Tecelão", allowedHeadingTexts: ["Tecelão"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Curador", { semanticAnchor: "Ofício Curador", allowedHeadingTexts: ["Curador"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Evocador", { semanticAnchor: "Ofício Evocador", allowedHeadingTexts: ["Evocador"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Artífice", { semanticAnchor: "Ofício Artífice", allowedHeadingTexts: ["Artífice"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["Batedor", { semanticAnchor: "Ofício Batedor", allowedHeadingTexts: ["Batedor"], allowedWindow: "SAME_HEADING_SUBTREE", family: "OFICIO_CULTURAL_OPENING" }],
  ["COMBATE E GRADE ORTOGONAL", { semanticAnchor: "Combate e grade ortogonal", allowedHeadingTexts: ["COMBATE E GRADE ORTOGONAL"], allowedWindow: "SAME_H2", family: "TECHNICAL_DIAGRAM" }],
  ["Rodada", { semanticAnchor: "Rodada", allowedHeadingTexts: ["Rodada"], allowedWindow: "SAME_HEADING_SUBTREE", family: "TECHNICAL_DIAGRAM" }],
  ["Dano e potência", { semanticAnchor: "Dano e potência", allowedHeadingTexts: ["Dano e potência"], allowedWindow: "SAME_HEADING_SUBTREE", family: "TECHNICAL_DIAGRAM" }],
  ["APÊNDICES", { semanticAnchor: "Apêndices", allowedHeadingTexts: ["APÊNDICES"], allowedWindow: "SAME_H1", family: "REFERENCE_GLYPH" }],
]);

const HISTORY_ASSETS = [
  ["Prólogo — A velha e a Fresta", "p004_velha_e_fresta_pb.png", "A velha e a Fresta", "REV1 §28 #6"],
  ["PARTE I — O MUNDO PARTIDO", "p005_cristal_partido_pb.png", "O Cristal Partido", "REV1 §28 · abertura da Parte I"],
  ["Manesh — O Mundo da Luz", "p006_manesh_pb.png", "Manesh — O Mundo da Luz", "REV1 §28 #7"],
  ["Thuvel — O Mundo da Escuridão", "p007_thuvel_pb.png", "Thuvel — O Mundo da Escuridão", "REV1 §28 #8"],
  ["Luz, Escuridão e Sombra", "p008_009_luz_escuridao_sombra_pb.png", "Luz, Escuridão e Sombra", "REV1 §28 #9"],
  ["O Grande Cristal — Antes Que Houvesse Dois Mundos", "p010_cristal_uno_pb.png", "O Grande Cristal", "REV1 §28 #11"],
  ["Mirveth — Uma Pessoa Inteira", "p011_mirveth_manesh_pb.png", "Mirveth — uma pessoa inteira", "REV1 §28 #12"],
  ["Vethari — Relação Sem Apagamento", "p012_mirveth_thuvel_pb.png", "Mirveth — relação entre mundos", "REV1 §28 #13"],
  ["Pedr’alma", "p013_pedralma_monolito_pb.png", "Pedr’alma", "REV1 §28 #14"],
  ["Lar · Cidade · Companhia", "p014_pedralma_escalas_pb.png", "Pedr’alma em lar, cidade e companhia", "REV1 §28 #15"],
  ["História do Mundo Partido", "p017_dois_mundos_fratura_pb.png", "Dois Mundos e a Fratura", "REV1 §28 #16"],
  ["A escrita contínua", "p019_silmain_pb.png", "Silmain", "REV1 §28 · Silmain"],
  ["As primeiras frestas controladas", "p020_primeiras_frestas_pb.jpg", "Primeiras Frestas", "REV1 §28 · primeiras frestas"],
  ["Kethrell e a doutrina da recomposição", "p021_022_kethrell_faccao_cientifica_pb.jpg", "Kethrell e a Facção", "REV1 §28 · Kethrell"],
  ["Os Outros", "p024_025_outros_lightbringers_pb.jpg", "Os Outros e os Lightbringers", "REV1 §28 · Outros / Lightbringers"],
  ["Daeren", "p026_027_daeren_thavin_isenna_pb.jpg", "Daeren, Thavin e Isenna", "REV1 §28 · Daeren / Thavin / Isenna"],
  ["A profecia de Thaeraen", "p028_029_thaeraen_tempo_escolha_pb.jpeg", "Thaeraen e o Tempo da Escolha", "REV1 §28 · Thaeraen"],
...
const thurDaerAsset = HISTORY_ASSETS.find((asset) => asset.heading === "Geografia da Escuridão: Vale de Thur-Daer");
if (thurDaerAsset) {
  thurDaerAsset.src = "/assets/v1.5-acervo/thur-daer-pb.png";
  thurDaerAsset.reference = "IMAGENS/KALLISTIS_LIVRO/P040_GEOGRAFIA_DA_ESCURIDAO_VALE_DE_THUR_DAER.png · variante PB";
}

[
  ["PARTE II — O CINTURÃO DAS FRESTAS", "parte-ii-cinturao.png", "O Cinturão das Frestas", "REV1 §28 #20"],
  ["PARTE III — POVOS, COMUNIDADES E CAMINHOS", "parte-iii-povos.png", "Povos, Comunidades e Caminhos", "REV1 §28 #39"],
  ["PARTE IV — MEMÓRIA, PEDR’ALMA E FÉ", "parte-iv-memoria.png", "Memória, Pedr’alma e Fé", "REV1 §28 #46"],
  ["O Mapa em Duas Camadas", "mapa-geral-cinturao-spread.png", "Mapa geral do Cinturão — splash de duas páginas", "IMAGENS/LUGARES_MAPAS/LUGARES_MAPAS_PRECISA_APROVAR/01_MAPA_GERAL_DUAS_CAMADAS__cf8db9e23c.png · variação local anexada"],
  ...
  ["Geografia da Escuridão: Vale de Thur-Daer", "thur-daer.png", "Vale de Thur-Daer", "REV1 §28 #26"],
  ["Rotas Oficiais", "rotas-oficiais.png", "Rotas Oficiais", "REV1 §28 #32"],
  ["Rotas Clandestinas e Comércio", "rotas-clandestinas.png", "Rotas Clandestinas e Comércio", "REV1 §28 #33"],
  ["O Estado Político Atual", "estado-politico.jpg", "Estado Político Atual", "REV1 §28 #36"],
  ["Tensões Regionais: Aelvari, Kragor, Draken e Nomos", "povo-aelvari.png", "Aelvari — tensão regional", "REV1 §28 #40"],
  ...
  ["Definição cultural de Pedr’alma", "pedralma-monumental.png", "Pedr’alma monumental", "REV1 §28 #46"],
  ["Pedra, símbolo e identidade", "pedralma-monolito.png", "Pedra, símbolo e identidade", "REV1 §28 #50"],
  ...
  ["A pergunta que atravessa a passagem", "encerramento-final.png", "Memória, fé e passagem", "REV1 §28 #85"],
...
[
  ...
  ["PARTE VI — JOGANDO KALLISTIS", "/assets/complete/parte-vi-jogando.png", "Jogando KALLISTIS", "REV1 §28 · Parte VI"],
  ["PARTE VII — CONDUZINDO KALLISTIS", "/assets/complete/parte-vii-conduzindo.png", "Conduzindo KALLISTIS", "REV1 §28 · Parte VII"],
  ["O QUE É VELARIM", "/assets/complete/parte-v-velarim.png", "O que é Velarim", "REV1 §28 #87"],
  ["Pedr’alma no uso de Velarim", "/assets/complete/pedralma-velarim.png", "Pedr’alma no uso de Velarim", "REV1 §28 #105"],
  ["Bestiário do Cristal Partido", "/assets/complete/bestiary/plates/bestiario-atmosfera.png", "Fauna e entidades do Cristal Partido — abertura atmosférica full art do Bestiário", "KIMG-C-0220 · acervo aprovado HIGH"],
  ["Drakos — a forma dracônica que não é Povo", "/assets/complete/bestiary/drakos.png", "Família dos Drakos", "REV1 §28 · bestiário"],
  ["Dragão Cristalino Colossal", "/assets/complete/bestiary/dragao-cristalino.png", "Dragão Cristalino Colossal", "REV1 §28 · bestiário"],
  ["Tartaruga-Fortaleza", "/assets/complete/bestiary/tartaruga-fortaleza.png", "Tartaruga-Fortaleza", "REV1 §28 · bestiário"],
  ["Leviatã dos Veios", "/assets/complete/bestiary/leviata.png", "Leviatã dos Veios", "REV1 §28 · bestiário"],
  ["Árvore-Mãe Errante", "/assets/complete/bestiary/arvore-mae.png", "Árvore-Mãe Errante", "REV1 §28 · bestiário"],
  ["Estilhaço Vitrálio Instável", "/assets/complete/bestiary/estilhaco.png", "Estilhaço Vitrálio Instável", "REV1 §28 · bestiário"],
  ["Corvo de Fresta", "/assets/complete/bestiary/corvo.png", "Corvo de Fresta", "REV1 §28 · bestiário"],
  ["Filhote de Tormenta", "/assets/complete/bestiary/filhote.png", "Filhote de Tormenta", "REV1 §28 · bestiário"],
  ["Autômato de Ponte Descontrolado", "/assets/complete/bestiary/automato.png", "Autômato de Ponte Descontrolado", "REV1 §28 · bestiário"],
  ["Eco Corrompido", "/assets/complete/bestiary/eco-corrompido.png", "Eco Corrompido", "REV1 §28 · bestiário"],
  ["Serpente do Leito Escrito", "/assets/complete/bestiary/serpente.png", "Serpente do Leito Escrito", "REV1 §28 · bestiário"],
  ["Cão-Leão das Brasas Errantes", "/assets/complete/bestiary/cao-leao.png", "Cão-Leão das Brasas Errantes", "REV1 §28 · bestiário"],
  ["Pato de Pressão Ressonante", "/assets/complete/bestiary/pato.png", "Pato de Pressão Ressonante", "REV1 §28 · bestiário"],
  ["Roedor dos Veios Fulminantes", "/assets/complete/bestiary/roedor.png", "Roedor dos Veios Fulminantes", "REV1 §28 · bestiário"],
  ["Devorador Psíquico Cefalóide", "/assets/complete/bestiary/devorador.png", "Devorador Psíquico Cefalóide", "REV1 §28 · bestiário"],
  ["Guardião", "/assets/complete/offices/guardiao.png", "Guardião — Ofício oficial", "REV1 §28 #13"],
  ["Duelista", "/assets/complete/offices/duelista.png", "Duelista — Ofício oficial", "REV1 §28 #13"],
  ["Atirador", "/assets/complete/offices/atirador.png", "Atirador — Ofício oficial", "REV1 §28 #13"],
  ...
  ["Evocador", "/assets/complete/offices/evocador.png", "Evocador — Ofício oficial", "REV1 §28 #13"],
  ["Artífice", "/assets/complete/offices/artifice.png", "Artífice — Ofício oficial", "REV1 §28 #13"],
...
[
  ["COMBATE E GRADE ORTOGONAL", "/assets/complete/diagrams/grid-tatico.svg", "Grade tática ortogonal — linha de visão, flanco e terreno difícil", "REV1 · diagrama técnico de regra"],
  ["Rodada", "/assets/complete/diagrams/economia-acao.svg", "Economia de ação por rodada — AP, AM, AR e AL", "REV1 · diagrama técnico de regra"],
  ["Dano e potência", "/assets/complete/diagrams/fluxo-dano.svg", "Fluxo canônico de dano e potência", "REV1 · diagrama técnico de regra"],
  ["APÊNDICES", "/assets/complete/support/apendices/simbolos-oficios-referencia.png", "Glifo de referência rápida dos Ofícios", "REV1 · referência tipográfica"],
].forEach(([heading, src, alt, reference]) => {
  HISTORY_ASSETS.push({
    heading,
...
[
  ["AELVARI", "/assets/complete/support/peoples/aelvari-context.png", "Aelvari — referência contextual de corpo inteiro"],
  ["KRAGOR", "/assets/complete/support/peoples/kragor-context.png", "Kragor — referência contextual de corpo inteiro"],
  ["DRAKEN", "/assets/complete/support/peoples/draken-context.png", "Draken — referência contextual de corpo inteiro"],
  ["NOMOS", "/assets/complete/support/peoples/nomos-context.png", "Nomos — referência contextual de corpo inteiro"],
  ["LIVRES", "/assets/complete/support/peoples/livres-context.png", "Livres — referência contextual de corpo inteiro"],
  ["DÓREOS", "/assets/complete/support/peoples/doreos-context.png", "Dóreos — referência contextual de corpo inteiro"],
  ["TERIANTES", "/assets/complete/support/peoples/teriantes-context.png", "Teriantes — referência contextual de corpo inteiro"],
  ["NIMARI", "/assets/complete/support/peoples/nimari-context.png", "Nimari — referência contextual de corpo inteiro"],
  ["VITRÁLIOS", "/assets/complete/support/peoples/vitralios-context.png", "Vitrálios — referência contextual de corpo inteiro"],
...
[
  ["Guardião", "/assets/complete/support/offices/guardiao-recurso.png", "Guardião — símbolo canônico do recurso G3"],
  ["Duelista", "/assets/complete/support/offices/duelista-recurso.png", "Duelista — símbolo canônico do recurso D1"],
  ["Atirador", "/assets/complete/support/offices/atirador-recurso.png", "Atirador — símbolo canônico do recurso A3"],
  ["Tecelão", "/assets/complete/support/offices/tecelao-recurso.png", "Tecelão — símbolo canônico do recurso T3"],
  ["Curador", "/assets/complete/support/offices/curador-recurso.png", "Curador — símbolo canônico do recurso C1"],
  ["Evocador", "/assets/complete/support/offices/evocador-recurso.png", "Evocador — símbolo canônico do recurso E2"],
  ["Artífice", "/assets/complete/support/offices/artifice-recurso.png", "Artífice — símbolo canônico do recurso AR2"],
  ["Batedor", "/assets/complete/support/offices/batedor-recurso.png", "Batedor — símbolo canônico do recurso B1"],
].forEach(([heading, src, alt]) => {
  HISTORY_ASSETS.push({
    heading,
    status: "COVERED_MEDIUM",
...
[
  ["Dragão Cristalino Colossal", "/assets/complete/support/bestiary/dragao-escala.png", "Dragão Cristalino Colossal — arte canônica de escala contextual"],
  ["Leviatã dos Veios", "/assets/complete/support/bestiary/leviata-escala.png", "Leviatã dos Veios — arte canônica de escala contextual"],
  ["Árvore-Mãe Errante", "/assets/complete/support/bestiary/arvore-mae-escala.png", "Árvore-Mãe Errante — arte canônica de escala contextual"],
].forEach(([heading, src, alt]) => {
  HISTORY_ASSETS.push({
    heading,
    status: "COVERED_MEDIUM",
...
[
  ["Bestiário do Cristal Partido", "/assets/complete/bestiary/ersomagem-duas-criaturas-full-art.png", "Ersomagem com duas criaturas — prancha de referência do Bestiário", "IMAGENS/KALLISTIS_LIVRO/KIMG-0048 · direção de arte do usuário"],
  ["Drakos — a forma dracônica que não é Povo", "/assets/complete/bestiary/plates/drako-cristal.png", "Drako de cristal — variante de referência", "KIMG-C-0004 · acervo aprovado HIGH"],
  ["Leviatã dos Veios", "/assets/complete/bestiary/plates/leviata-variante-b.png", "Leviatã dos Veios — variante B", "KIMG-C-0032 · acervo aprovado HIGH"],
  ["Devorador Psíquico Cefalóide", "/assets/complete/bestiary/plates/devorador-variante.png", "Devorador Psíquico Cefalóide — variante de referência", "KIMG-C-0133 · acervo aprovado HIGH"],
  ["Autômato de Ponte Descontrolado", "/assets/complete/bestiary/plates/automato-variante.png", "Autômato de Ponte Descontrolado — variante de referência", "KIMG-C-0096 · acervo aprovado HIGH"],
].forEach(([heading, src, alt, reference]) => {
  HISTORY_ASSETS.push({
    heading,
    status: "COVERED_HIGH",
...
async function enrichAcervoAssets(sourceBlocks) {
  ...
  const sourceHeadings = new Set(sourceBlocks.filter((source) => source.type === "heading").map((source) => source.text));
  const occupiedHeadings = new Set(HISTORY_ASSETS.filter((asset) => !asset.supportOnly).map((asset) => asset.heading));
  ...
  for (const [heading, pattern] of EXTRA_ACERVO_OVERRIDES) {
    ...
    const candidate = localFiles.find((file) => !selectedFiles.has(file) && pattern.test(path.basename(file)));
    ...
    const materializedSrc = existingPath ? `/${path.relative(path.join(ROOT, "public"), existingPath)}` : `/assets/v1.5-acervo/${targetName}`;
    const existingAsset = HISTORY_ASSETS.find((asset) => !asset.supportOnly && asset.heading === heading);
    if (existingAsset) {
  ...
  for (const [heading, pattern] of EXTRA_ACERVO_RULES) {
    ...
    selected.push({
      ...
      sourcePath: candidate,
      sourceSha256: sha,
      src: existingPath ? `/${path.relative(path.join(ROOT, "public"), existingPath)}` : `/assets/v1.5-acervo/${targetName}`,
  ...
  await writeFile(V15_INVENTORY_PATH, `${JSON.stringify({ generatedAt: new Date().toISOString(), sourceRoot: LOCAL_IMAGE_ROOT, noImageGeneration: true, totalRasterFiles: inventory.length, selectedForV15: selected.length, inventory }, null, 2)}\n`, "utf8");
  const csv = ["relativePath,sha256,disposition,contexts,materializedSrc", ...inventory.map((entry) => [entry.relativePath, entry.sha256, entry.disposition, entry.contexts.join(" | "), entry.materializedSrc ?? ""].map(csvCell).join(","))].join("\n") + "\n";
...
function parseScopeLines(lines, scope) {
  const h1 = lines.map((line, index) => ({ line, index: index + 1 })).filter(({ line }) => /^#\s+/u.test(line));
...
function parseMarkdown(markdown, scope) {
  ...
  while (i < selected.lines.length) {
    ...
    if (i + 1 < selected.lines.length && line.includes("|") && isTableSeparator(selected.lines[i + 1])) {
      const tableLines = [line, selected.lines[i + 1]];
      i += 2;
      while (i < selected.lines.length && selected.lines[i].trim() && selected.lines[i].includes("|")) {
    ...
    if (/^\s*>/u.test(line)) {
      const quoteLines = [];
      const start = i;
      while (i < selected.lines.length && (/^\s*>/u.test(selected.lines[i]) || !selected.lines[i].trim())) {
    ...
    if (isListLine(line)) {
      const listLines = [];
      const start = i;
      while (i < selected.lines.length && (isListLine(selected.lines[i]) || !selected.lines[i].trim())) {
    ...
    while (i < selected.lines.length) {
      ...
      if (!current.trim() || headingMatch(current) || isListLine(current) || /^\s*>/u.test(current)) break;
      if (i + 1 < selected.lines.length && current.includes("|") && isTableSeparator(selected.lines[i + 1])) break;
...
function bindSemanticAssets(sourceBlocks) {
  ...
  for (const asset of HISTORY_ASSETS) {
    const matchingSources = asset.allowedHeadingTexts.flatMap((text) => headingsByText.get(text) ?? [])
      .filter((source) => !asset.allowedSectionH2 || source.headingPath?.some((heading) => heading.text === asset.allowedSectionH2));
    ...
    if (!asset.allowedHeadingIds.length || !asset.anchorHeadingId) {
      if (scope === "HISTORIA" && !asset.family) throw new Error(`Âncora sem heading canônico: ${asset.heading}`);
      continue;
    }
    asset.semanticPairId = asset.allowedHeadingIds.length > 1 ? `shared-${asset.heading}` : undefined;
    asset.layoutRole = asset.semanticPairId ? "SHARED_EDITORIAL_IMAGE" : "EDITORIAL_IMAGE";
    if (!asset.supportOnly) for (const headingText of asset.allowedHeadingTexts) VISUAL_CATALOG.set(headingText, asset);
  }
  const partOpeningAsset = VISUAL_CATALOG.get("PARTE I — O MUNDO PARTIDO");
  for (const headingText of REUSED_FINAL_ART_HEADINGS) VISUAL_CATALOG.set(headingText, partOpeningAsset);
  return sourceBlocks;
}
...
function assetForSource(source) {
  ...
  const directContext = HISTORY_ASSETS.find((asset) =>
    asset.heading === source.text &&
    asset.extraContext &&
    EXTRA_PRIMARY_CONTEXT_HEADINGS.has(source.text),
  );
  const peopleContext = HISTORY_ASSETS.find((asset) =>
    asset.heading === source.text &&
    asset.supportKind === "people-context",
  );
  ...
  if (candidateForFamily.family === "POVO_OPENING") {
    const peopleImage = peopleContext ?? (candidateForFamily.supportKind === "people-context" ? candidateForFamily : null);
    if (peopleImage) {
      return {
        ...peopleImage,
        supportOnly: false,
...
function supportAssetsForSource(source) {
  ...
  return HISTORY_ASSETS.filter((asset) =>
    asset.supportOnly &&
    !asset.fullArtPlate &&
...
function fullArtPlateAssetsForSource(source) {
  if (!source || source.type !== "heading") return [];
  return HISTORY_ASSETS.filter((asset) => asset.fullArtPlate && asset.allowedHeadingIds?.includes(source.id));
}
...
function tableBlockFromSource(source, bodyRows = null, continuationIndex = 0) {
  const isChronology = (source.headingPath ?? []).some((heading) => heading.text === "Cronologia consolidada por Marcos");
  const cleanCell = (content) => stripMarkdown(content);
  const headerCells = (source.tableLines?.[0] ? splitTableRow(source.tableLines[0]) : []).map((content, index) => ({
    id: blockId(source, `th-${index + 1}`), content: cleanCell(content),
  }));
  const rawRows = (source.tableLines ?? []).slice(2).map((line) => splitTableRow(line).map(cleanCell));
  ...
  const body = rows.map((cells, rowIndex) => ({
    id: blockId(source, `r-${continuationIndex}-${rowIndex + 1}`), kind: "body", cells: cells.map((content, cellIndex) => ({
      id: blockId(source, `r-${continuationIndex}-${rowIndex + 1}-c-${cellIndex + 1}`), content,
    })),
  }));
  const longCell = [headerCells.map((cell) => cell.content), ...rows].flat().some((content) => content.length > 42);
  const columnWeights = headerCells.map((header, index) => {
    const maxLength = Math.max(header.content.length, ...rows.map((row) => row[index]?.length ?? 0));
  ...
  return {
    ...
    ...(continuationIndex ? { continuationOf: source.id, continuationIndex, continuationHeader: [header] } : {}),
...
function sourceToBlock(source) {
  ...
  if (source.type === "heading") {
    return { id: blockId(source), type: "heading", level: source.level, text: source.text, materialization };
  }
  if (source.type === "paragraph") {
    return { id: blockId(source), type: "text", role: "body", content: source.raw.split("\n").join(" ").trim(), align: "justify", materialization };
  }
  if (source.type === "list") {
    return { id: blockId(source), type: "text", role: "body", content: source.raw, align: "start", materialization };
  }
  if (source.type === "blockquote") {
    return { id: blockId(source), type: "quote", text: source.raw.replace(/^>\s?/gmu, "").replace(/\n+/g, " ").trim(), size: "md", materialization };
  }
...
function generatedImage(source, asset, size = "medium", occurrence = 0) {
  ...
  const quadrantFamily = !fullArtOpening && ["POVO_OPENING", "OFICIO_CULTURAL_OPENING", "BESTIARY_ENTRY"].includes(asset.family);
  const sidePortrait = ["POVO_OPENING", "OFICIO_CULTURAL_OPENING", "TENSION_OPENING", "BESTIARY_ENTRY"].includes(asset.family);
  const side = Boolean(asset.semanticPairId) || sidePortrait || ["Pedr’alma", "Lar · Cidade · Companhia", "Daeren"].includes(asset.heading);
  ...
  return {
    ...
    ...(REUSED_FINAL_ART_HEADINGS.has(source.text) ? { mirror: occurrence % 2 === 1, objectX: occurrence % 2 === 0 ? 25 : 75 } : {}),
    frameAspectRatio: fullArtOpening ? 0.6667 : quadrantFamily ? 0.62 : size === "small" ? 3.8 : side ? 0.55 : asset.family === "MAP_PAGE" ? 0.93 : 1.9,
    layoutRole: fullArtOpening ? "FULL_ART" : quadrantFamily ? "QUADRANT_IMAGE" : shared ? "SHARED_EDITORIAL_IMAGE" : "EDITORIAL_IMAGE",
...
function editorialFamilyForSource(source, ordinal = 0) {
  ...
  if (source?.text === "Apresentação" || source?.text === "Como usar este livro") return "INTRODUCTION";
...
function compositionForSource(source, asset = null, ordinal = 1) {
  ...
  if (family === "TITLE_PAGE") return { family: "TEXT_FLOW", template: "front_matter", variant: "title-page" };
  if (family === "COPYRIGHT_EXPEDIENTE") return { family: "TEXT_FLOW", template: "front_matter", variant: "copyright" };
  if (family === "DEDICATION") return { family: "TEXT_FEATURE", template: "front_matter", variant: "dedication" };
  if (family === "INTRODUCTION") return { family: "TEXT_FLOW", template: "front_matter", variant: "introduction" };
  if (family === "PART_OPENING") return { family: "PART_HERO", template: "part_opening", variant: "default" };
  ...
  if (asset?.family === "MAP_PAGE") return { family: "MAP_PAGE", template: "chapter_opening", variant: "image-top" };
  ...
  if (asset?.semanticPairId) return { family: "SIDE_ART_PAIR", template: "chapter_opening", variant: "image-side" };
  if (asset && ["Pedr’alma", "Lar · Cidade · Companhia", "Daeren"].includes(asset.heading)) {
    return { family: source.text === "Daeren" ? "SIDE_ART_LEFT" : "SIDE_ART_RIGHT", template: "chapter_opening", variant: source.text === "Daeren" ? "image-side" : "image-side" };
  }
  if (asset) return { family: "IMAGE_TOP", template: "chapter_opening", variant: "image-top" };
  if (/^PARTE II\b/u.test(source.sectionH1 ?? "")) return { family: "GEOGRAPHY_FLOW", template: "narrative", variant: "default" };
  if (/^PARTE III\b/u.test(source.sectionH1 ?? "")) return { family: "CULTURE_FLOW", template: "narrative", variant: "default" };
  if (source.type === "text" && source.wordCount <= 24) return { family: "TEXT_FEATURE", template: "narrative", variant: "default" };
...
function applyCompactReferencePage(page, source) {
  if (!compactReferenceSection(source) || page.template === "part_opening" || page.blocks.some((block) => block.type === "image")) {
    return page;
  }
  return {
    ...page,
...
function newPage(scope, ordinal, hint) {
  ...
  const frontMatter = ["TITLE_PAGE", "COPYRIGHT_EXPEDIENTE", "DEDICATION", "INTRODUCTION"].includes(editorialFamilyForSource(hint, ordinal));
...
function pageSourceIds(page) {
  return [...new Set(page.blocks.map((block) => block.materialization?.sourceBlockId).filter(Boolean))];
}

function pageWordCount(page) {
  return page.blocks.reduce((total, block) => {
    if (block.type === "image" || block.type === "divider") return total;
    if (block.type === "table") return total + block.rows.reduce((sum, row) => sum + row.cells.reduce((n, cell) => n + wordCount(cell.content), 0), 0);
...
function updatePageMetadata(page, sourceById) {
  ...
  const pageStartsAtFirstHeading = page.blocks[0]?.materialization?.sourceBlockId === firstHeading?.id;
  ...
  if (firstHeading && (firstHeading.text === "A história em Marcos" || /^MARCO\s+/u.test(firstHeading.text ?? "") || (firstHeading.level === 1 && /^PARTE\s+/u.test(firstHeading.text ?? "")))) {
  ...
  const start = sources.length ? Math.min(...sources.map((source) => source.sourceStartLine)) : undefined;
  const end = sources.length ? Math.max(...sources.map((source) => source.sourceEndLine)) : undefined;
...
function applyPreexistingEditorialCorrections(book) {
  ...
  addOnce(77, correctionImageBlock(book.pages[76], "distribuicao-p77", "/assets/v1.5-acervo/distribuicao-povos.png", "Distribuição dos povos, comunidades e caminhos — imagem contextual", {
    position: "flow",
    width: "100%",
    height: "52mm",
    frameAspectRatio: 3.05,
  }), 1);
  addOnce(90, correctionImageBlock(book.pages[89], "aelvari-p90", "/assets/complete/support/peoples/aelvari-context.png", "Aelvari — imagem contextual do povo", {
    position: "left",
    width: "34%",
    height: "86mm",
    frameAspectRatio: 0.63,
  }), 2);
  addOnce(141, correctionImageBlock(book.pages[140], "nimari-p141", "/assets/complete/support/peoples/nimari-context.png", "Nimari — imagem contextual do povo", {
    position: "right",
    width: "30%",
    height: "52mm",
    frameAspectRatio: 0.92,
  }), 1);
  addOnce(142, correctionImageBlock(book.pages[141], "vitralios-p142", "/assets/complete/support/peoples/vitralios-context.png", "Vitrálios — imagem contextual do povo", {
    position: "overlay-right",
    width: "30%",
    height: "32mm",
    frameAspectRatio: 1.5,
  }), 1);
  addOnce(162, correctionImageBlock(book.pages[161], "kelvhen-p162", "/assets/v1.5-acervo/forja-kelvhen.png", "Kelvhen — forja arcana na Catedral de Cristal, imagem contextual", {
    position: "overlay-right",
    width: "30%",
    height: "34mm",
...
function splitSentences(content) {
  const parts = content.trim().split(/(?<=[.!?…])\s+(?=[A-ZÀ-ÖØ-ÞÁÉÍÓÚÂÊÔÃÕÇ“"'—])/u).filter(Boolean);
...
function fragmentText(block, content, index, count) {
  const materialization = { ...block.materialization, sourceFragmentIndex: index, sourceFragmentCount: count };
  if (index > 0) delete materialization.sourceRaw;
  return { ...block, id: `${block.materialization.sourceBlockId}-fragment-${index + 1}`, content, materialization };
}
...
function splitTable(block, bodyCount, continuationIndex, fragmentCount = 1) {
  ...
  const materialization = { ...block.materialization, sourceFragmentIndex: continuationIndex, sourceFragmentCount: fragmentCount };
  if (continuationIndex > 0) delete materialization.sourceRaw;
  return {
    ...block,
    id: continuationIndex ? `${block.materialization.sourceBlockId}-fragment-${continuationIndex + 1}` : block.id,
    rows: continuationIndex ? rows : [...headerRows, ...rows],
    ...(continuationIndex ? { continuationOf: block.materialization.sourceBlockId, continuationIndex, continuationHeader: headerRows } : {}),
    materialization,
  };
}
...
async function renderAndMeasure(page, book) {
  ...
  await page.evaluate(({ nextBook, nextRevision }) => {
    window.dispatchEvent(new CustomEvent("kallistis-materializer-book", { detail: { book: nextBook, revision: nextRevision } }));
  }, { nextBook: book, nextRevision: revision });
  await page.waitForFunction((expectedRevision) => document.documentElement.dataset["materializerRevision"] === String(expectedRevision) && document.documentElement.dataset["printReady"] === "true", revision, { timeout: 120000 });
  return page.evaluate(() => {
    ...
    const usedBottom = blockInfo.reduce((max, block) => block.isImage ? max : Math.max(max, contentRect.top + block.bottom), contentRect.top);
    const blockOutOfBounds = blockInfo.some((block) => !block.isImage && (block.top < -1 || block.bottom > contentRect.height + 1));
    return {
      overflow: blockOutOfBounds || (specialCopy
        ? (specialCopy.scrollHeight > specialCopy.clientHeight + 1 || specialCopy.scrollWidth > specialCopy.clientWidth + 1)
        : (!["part_opening", "full_art"].includes(root.dataset.template ?? "") && (content.scrollHeight > content.clientHeight + 1 || content.scrollWidth > content.clientWidth + 1))),
      scrollHeight: content.scrollHeight,
      clientHeight: content.clientHeight,
      scrollWidth: content.scrollWidth,
      clientWidth: content.clientWidth,
      usedHeight: Math.max(0, usedBottom - contentRect.top),
      fillRatio: content.clientHeight ? Math.max(0, usedBottom - contentRect.top) / content.clientHeight : 0,
      blockInfo,
      tableRows: [...content.querySelectorAll("[data-table-row-id]")].map((row) => {
        const rect = row.getBoundingClientRect();
        return { id: row.getAttribute("data-table-row-id"), top: rect.top - contentRect.top, bottom: rect.bottom - contentRect.top };
      }),
    };
  });
}
...
async function materialize({ scope, markdown, baseBook, browserPage, sourceBlocks }) {
  ...
  const measureCurrentWithBlocks = async (blocks) =>
    renderAndMeasure(browserPage, candidateBook(baseBook, { ...current, blocks: [...current.blocks, ...blocks] }, pages.length));
  ...
  const finishCurrent = async (nextHint = null) => {
    ...
    const measurement = await renderAndMeasure(browserPage, candidateBook(baseBook, current, pages.length));
    ...
    current = newPage(scope, pages.length, nextHint ?? sourceBlocks.find((source) => source.sectionH2 === current.chapter) ?? sourceBlocks[0]);
  };

  const trySplitText = async (block) => {
    if (block.type !== "text") return null;
    const pieces = block.materialization?.sourceType === "list" ? block.content.split("\n").filter(Boolean) : splitSentences(block.content);
    ...
    while (low <= high) {
      ...
      const content = block.materialization?.sourceType === "list" ? pieces.slice(0, middle).join("\n") : pieces.slice(0, middle).join(" ");
    ...
    if (!best) return null;
    const first = block.materialization?.sourceType === "list" ? pieces.slice(0, best).join("\n") : pieces.slice(0, best).join(" ");
    const rest = block.materialization?.sourceType === "list" ? pieces.slice(best).join("\n") : pieces.slice(best).join(" ");
  ...
  const trySplitTable = async (block) => {
    ...
    const incomingIndex = block.continuationIndex ?? block.materialization?.sourceFragmentIndex ?? 0;
    ...
    const rest = splitTable({ ...block, rows: bodyRows.slice(best) }, bodyRows.length - best, nextIndex, fragmentCount);
    return [first, rest];
  };

  const addBlock = async (block) => {
    if (block.type === "table" && /^PARTE VII\b/u.test(current.part ?? "") && !current.blocks.some((candidate) => candidate.type === "image")) {
      current = {
        ...current,
        template: "rules_2col",
        variant: "default",
    ...
    if (split) {
      ...
      const isChronologyContinuation = rest.type === "table" &&
        rest.continuationIndex === 1 &&
        continuationSource?.headingPath?.some((heading) => heading.text === "Cronologia consolidada por Marcos");
  ...
  for (let index = 0; index < sourceBlocks.length; index += 1) {
    ...
    const frontMatterBoundary = scope === "HISTORIA" && source.type === "heading" && source.level === 2 && ["Expediente", "Dedicatória", "Apresentação", "Prólogo — A velha e a Fresta"].includes(source.text);
    const timelineBoundary = source.type === "heading" && (source.text === "A história em Marcos" || source.text === "Cronologia consolidada por Marcos" || /^MARCO\s+/u.test(source.text ?? ""));
    const timelineMilestoneFollowsTitle = source.type === "heading" && /^MARCO\s+/u.test(source.text ?? "") && current.blocks.length > 0 && current.blocks.every((candidate) => candidate.type === "heading" && candidate.text === "A história em Marcos");
    const forcedTensionContinuationBreak = source.type === "heading" && source.text === "Tensões Regionais: Livres, Dóreos, Teriantes, Nimari e Vitrálios";
    const forcedChavesBreak = source.type === "heading" && source.text === "CHAVES, VOZES E PRESENÇA EM MESA";
    const compositionBoundary = source.type === "heading" && (asset || supportAssets.some((candidate) => !candidate.extraContext) || forcedTensionContinuationBreak || forcedChavesBreak || current.editorialFamily === "PART_OPENING" || (timelineBoundary && !timelineMilestoneFollowsTitle));
    const sparseCurrent = isSparseNarrativePage(current);
    const independentOpening = ["MAP_PAGE", "GEOGRAPHY_OPENING", "POVO_OPENING", "OFICIO_CULTURAL_OPENING", "PEDRALMA_OPENING", "TENSION_OPENING", "TENSION_CONTINUATION", "FINAL_CLOSURE"].includes(asset?.family);
    const absorbSparseAssetOpening = sparseCurrent && source.type === "heading" && Boolean(asset) && !independentOpening;
    if (source.type === "heading" && (source.level === 1 || frontMatterBoundary || compositionBoundary) && current.blocks.length && !absorbSparseAssetOpening) {
      const currentSources = pageSourceIds(current).map((id) => sourceById.get(id)).filter(Boolean);
      const currentPathIds = new Set((currentSources.at(-1)?.headingPath ?? []).map((heading) => heading.id));
      const transitionAsset = sparseCurrent && !asset
        ? HISTORY_ASSETS.find((candidate) => candidate.allowedHeadingIds.some((headingId) => currentPathIds.has(headingId)))
        : null;
    ...
    if (source.type === "heading" && source.text === "O Mapa em Duas Camadas" && asset?.family === "MAP_PAGE" && current.blocks.length === 0) {
      ...
      for (const side of ["left", "right"]) {
        ...
        const measurement = await renderAndMeasure(browserPage, candidateBook(baseBook, splash, pages.length));
    ...
    const firstPriority = source.type === "heading" && (source.text.startsWith("Prólogo") || source.level === 1);
    const cadenceReached = visualDebt >= IMAGE_CADENCE.targetInterval || textRun >= SOFT_MAX_TEXT_RUN || interval >= IMAGE_CADENCE.targetInterval;
    const pairCount = asset?.semanticPairId ? (usedSemanticPairs.get(asset.semanticPairId) ?? 0) : 0;
    const canReusePair = Boolean(asset?.semanticPairId) || ["POVO_OPENING", "OFICIO_CULTURAL_OPENING", "BESTIARY_ENTRY"].includes(asset?.family) || REUSED_FINAL_ART_HEADINGS.has(source.text) || REUSABLE_SEMANTIC_ART_HEADINGS.has(source.text);
    ...
    const semanticCompositionRecommended = (Boolean(asset) || supportAssets.length > 0) && source.type === "heading" && (current.blocks.length === 0 || absorbSparseAssetOpening);
    if (canUseAsset && semanticCompositionRecommended && !current.blocks.some((blockCandidate) => blockCandidate.type === "image") && (firstPriority || cadenceReached || Boolean(asset))) {
      image = generatedImage(source, asset, REUSED_FINAL_ART_HEADINGS.has(source.text) ? "small" : firstPriority ? "large" : "medium", pairCount);
      usedAssetShas.add(asset.sha);
    ...
    if (source.type === "heading") {
      if (current.blocks.length && source.level >= 2) {
        ...
        const isEncounterEntry = source.headingPath?.some((heading) => heading.text === ENCOUNTER_SECTION) && source.level >= 3;
        const currentEncounterEntries = current.blocks.filter((candidate) => candidate.type === "heading" && sourceById.get(candidate.materialization?.sourceBlockId)?.headingPath?.some((heading) => heading.text === ENCOUNTER_SECTION)).length;
        ...
        const allowTableContinuation = current.template === "rules_2col" && nextSource?.type === "table";
        const tableStartPreview = allowTableContinuation
          ? tableBlockFromSource(nextSource, (nextSource.tableLines ?? []).slice(2, 3).map((line) => splitTableRow(line).map(stripMarkdown)), 0)
          : null;
        const headingWithTableStart = tableStartPreview
          ? await measureCurrentWithBlocks([block, tableStartPreview])
          : keepWithNext;
        if ((headingMeasurement.overflow || (headingWithTableStart.overflow && allowTableContinuation) || (keepWithNext.overflow && !allowTableContinuation)) && !mayPairEncounterEntries) {
          await finishCurrent(source);
        }
      }
    }
    ...
    if (source.type === "heading" && fullArtPlates.length) {
      ...
      for (const plateAsset of fullArtPlates) {
        ...
        const measurement = await renderAndMeasure(browserPage, candidateBook(baseBook, plate, pages.length));
  ...
  for (let index = 0; index < pages.length - 1; index += 1) {
    ...
    const previousMeasurement = await renderAndMeasure(browserPage, candidateBook(baseBook, previousCandidate, index));
    const nextMeasurement = await renderAndMeasure(browserPage, candidateBook(baseBook, nextCandidate, index + 1));
  ...
  pages.forEach((page, index) => {
    ...
    if (page.materialization && pageMeasurements[index]) page.materialization.pageFillRatio = pageMeasurements[index].fillRatio;
  });
...
function validationTextForBlock(block) {
  ...
  if (block.type === "table") {
    return block.rows
      .filter((row) => row.kind !== "header" || (block.materialization?.sourceFragmentIndex ?? 0) === 0)
...
function wordMultiset(value) {
  ...
  for (const token of normalizedValidationText(value).toLocaleLowerCase("pt-BR").split(/\s+/u).filter(Boolean)) {
...
function wordDelta(expected, actual) {
  ...
  let lost = 0;
  let added = 0;
  for (const [word, count] of expectedCounts) lost += Math.max(0, count - (actualCounts.get(word) ?? 0));
  for (const [word, count] of actualCounts) added += Math.max(0, count - (expectedCounts.get(word) ?? 0));
  return { lost, added };
}
...
function semanticImagePlacements(book, sourceBlocks) {
  const sourceById = new Map(sourceBlocks.map((source) => [source.id, source]));
  const firstPageIndex = sourceBlocks[0]?.scope === "PARTES_I_IV"
    ? 53
    : sourceBlocks[0]?.scope === "COMPLETO"
      ? Math.max(0, book.pages.findIndex((page) => page.materialization?.scope === "COMPLETO"))
      : 0;
  return book.pages.slice(firstPageIndex).flatMap((page, relativePageIndex) => page.blocks.flatMap((block, blockIndex) => {
    if (block.type !== "image") return [];
    const sourceAssetId = block.materialization?.assetSourceBlockId;
    const asset = HISTORY_ASSETS.find((candidate) => candidate.src === block.src && sourceAssetId && candidate.allowedHeadingIds?.includes(sourceAssetId))
    ...
    for (const previousBlock of page.blocks.slice(0, blockIndex + 1)) {
      const source = sourceById.get(
        previousBlock.materialization?.sourceBlockId ?? previousBlock.materialization?.assetSourceBlockId,
      );
    ...
    const adjacent = Boolean(asset && asset.allowedHeadingIds.some((headingId) => actualHeadingIds.includes(headingId)));
    ...
    return [{
      ...
      actualH2: path.find((heading) => heading.level === 2)?.text ?? path.find((heading) => heading.level === 1)?.text ?? null,
      actualHeadingIds,
      semanticStatus,
    }];
  }));
...
function validateMaterialization(book, sourceBlocks, originalHash, outputPath, finalMeasurements, assetHashes) {
  ...
  const { occurrences, orderedIds: seenIds } = collectMaterializedSourceOccurrences(book, new Set(expectedIds));
  ...
  for (const source of sourceBlocks) {
    const records = (occurrences.get(source.id) ?? []).slice().sort((a, b) => a.fragmentIndex - b.fragmentIndex || a.pageIndex - b.pageIndex || a.blockIndex - b.blockIndex);
    ...
    for (const list of grouped.values()) if (list.length > 1) duplicateFragmentOccurrences += list.length - 1;
    const declaredCount = records.length ? Math.max(...records.map((record) => record.fragmentCount)) : 1;
    const indexes = [...grouped.keys()].sort((a, b) => a - b);
    const expectedIndexes = Array.from({ length: declaredCount }, (_, index) => index);
    if (indexes.length !== expectedIndexes.length || indexes.some((index, position) => index !== expectedIndexes[position])) {
      fragmentSequenceErrors += 1;
    }
    const actual = indexes.flatMap((index) => grouped.get(index).map((record) => validationTextForBlock(record.block))).join("\n");
    if (normalizedValidationText(expected) !== normalizedValidationText(actual)) {
      sourceBlockTextMismatches += 1;
      sourceTextMismatchDetails.push({ sourceBlockId: source.id, sourceStartLine: source.sourceStartLine, expected: normalizedValidationText(expected), actual: normalizedValidationText(actual) });
    }
  ...
  const brokenTableRows = finalMeasurements.reduce((count, measurement) => count + measurement.tableRows.filter((row) => row.top < -1 || row.bottom > measurement.clientHeight + 1).length, 0);
  ...
  return {
    ...
    MANUSCRIPT_TEXT_CHANGED: sourceBlockTextMismatches || sourceWordsLost || sourceWordsAdded ? 1 : 0,
    ...
    OVERFLOW_PAGE_NUMBERS: finalMeasurements.flatMap((measurement, index) => measurement.overflow ? [index + 1] : []),
    ...
    INVALID_IMAGE_PLACEMENTS: semanticPlacements.filter((placement) => placement.semanticStatus === "INVALID").length,
    ...
    TARGET_PAGE_COUNT_MISMATCH: sourceBlocks[0]?.scope === "COMPLETO" && book.pages.length > PAGINATION_POLICY.targetBookPages ? 1 : 0,
  };
}

function stats(book, measurements, sourceBlocks) {
  const imagePages = book.pages.map((page, index) => page.blocks.some((block) => block.type === "image") ? index : -1).filter((index) => index >= 0);
  const intervalSegments = imagePages.length
    ? [imagePages[0], ...imagePages.slice(1).map((page, index) => page - imagePages[index]), book.pages.length - 1 - imagePages.at(-1)]
    : [book.pages.length];
  const bodyPageIndexes = book.pages.map((page, index) => [page, index]).filter(([page]) => ["PART_OPENING", "NARRATIVE"].includes(page.materialization?.editorialFamily)).map(([, index]) => index);
  const bodyImagePages = bodyPageIndexes.filter((index) => book.pages[index].blocks.some((block) => block.type === "image"));
  const bodyImageIntervals = bodyImagePages.slice(1).map((page, index) => page - bodyImagePages[index]);
  const bodyPages = book.pages.filter((page) => page.materialization?.editorialFamily === "NARRATIVE" && !page.blocks.some((block) => block.type === "image"));
  const textPageWords = bodyPages.map((page) => page.materialization?.wordCount ?? 0).filter((count) => count > 0).sort((a, b) => a - b);
  ...
  for (const page of book.pages) {
    ...
    if (hasImage) {
      if (textRun) textRuns.push({ startPage: runStart + 1, endPage: book.pages.indexOf(page), length: textRun });
      textRun = 0;
  ...
  if (textRun) textRuns.push({ startPage: runStart + 1, endPage: book.pages.length, length: textRun });
  const bodyTextRuns = [];
  let bodyTextRun = 0;
  let bodyRunStart = 0;
  ...
  for (const pageIndex of bodyPageIndexes) {
    ...
    if (hasImage) {
      if (bodyTextRun) bodyTextRuns.push({ startPage: bodyRunStart + 1, endPage: pageIndex, length: bodyTextRun });
      bodyTextRun = 0;
  ...
  if (bodyTextRun) bodyTextRuns.push({ startPage: bodyRunStart + 1, endPage: bodyPageIndexes.at(-1) + 1, length: bodyTextRun });
  const vertical = measurements.reduce((totals, measurement) => {
    const blocks = measurement.blockInfo ?? [];
    const gaps = blocks.slice(1).reduce((sum, block, index) => sum + Math.max(0, block.top - blocks[index].bottom), 0);
    const headings = blocks.filter((block) => block.isHeading).reduce((sum, block) => sum + block.height, 0);
    const images = blocks.filter((block) => block.isImage).reduce((sum, block) => sum + block.height, 0);
  ...
  const percent = (value) => vertical.used ? Number(((value / vertical.used) * 100).toFixed(2)) : 0;
  const usedAssetShas = new Set(book.pages.flatMap((page) => page.blocks.filter((block) => block.type === "image").map((block) => HISTORY_ASSETS.find((asset) => asset.src === block.src)?.sha).filter(Boolean)));
  const unusedValidHistoryAssets = HISTORY_ASSETS.filter((asset) => !usedAssetShas.has(asset.sha)).map((asset) => asset.heading);
  const usedHistoryAssets = HISTORY_ASSETS.filter((asset) => usedAssetShas.has(asset.sha)).map((asset) => ({ heading: asset.heading, sha256: asset.sha }));
  const editorialFamilyCounts = Object.fromEntries(["TITLE_PAGE", "COPYRIGHT_EXPEDIENTE", "DEDICATION", "INTRODUCTION", "PART_OPENING", "NARRATIVE"].map((family) => [family, book.pages.filter((page) => page.materialization?.editorialFamily === family).length]));
  const compositionFamilies = ["PART_HERO", "IMAGE_TOP", "SIDE_ART_LEFT", "SIDE_ART_RIGHT", "SIDE_ART_PAIR", "MAP_PAGE", "MAP_SPREAD", "GEOGRAPHY_OPENING", "POVO_OPENING", "OFICIO_CULTURAL_OPENING", "BESTIARY_ENTRY", "PEDRALMA_OPENING", "GEOGRAPHY_FLOW", "CULTURE_FLOW", "TEXT_FLOW", "TEXT_FEATURE", "TIMELINE_MILESTONE"];
  const compositionFamilyCounts = Object.fromEntries(compositionFamilies.map((family) => [
    family,
    family === "MAP_SPREAD"
      ? book.pages.filter((page) => page.blocks.some((block) => block.type === "image" && block.spreadSide)).length
      : family === "MAP_PAGE"
        ? book.pages.filter((page) => page.materialization?.compositionFamily === family && !page.blocks.some((block) => block.type === "image" && block.spreadSide)).length
        : book.pages.filter((page) => page.materialization?.compositionFamily === family).length,
  ]));
  const futureProductRoleCounts = Object.fromEntries(["CORE", "GM_CANDIDATE", "PLAYER_REFERENCE", "UNDECIDED"].map((role) => [role, book.pages.filter((page) => page.futureProductRole === role).length]));
  ...
  return {
    ...
    TEXT_ONLY_PAGES: book.pages.filter((page) => !page.blocks.some((block) => block.type === "image")).length,
    ...
    PAGES_WITH_TABLES: book.pages.filter((page) => page.blocks.some((block) => block.type === "table")).length,
    PAGES_WITH_MAPS: book.pages.filter((page) => page.editorialComposition === "MAP_PAGE" || page.blocks.some((block) => block.type === "image" && /map|mapa/iu.test(block.alt ?? ""))).length,
    PAGES_WITH_REVIEW_FLAGS: book.pages.filter((page) => (page.materialization?.reviewFlags ?? []).length > 0).length,
    ...
    TRAILING_TEXT_PAGES: imagePages.length ? book.pages.length - imagePages.at(-1) - 1 : book.pages.length,
    TEXT_RUNS: textRuns,
    ...
    PAGE_FILL_MEAN: Number(mean(measurements.map((measurement) => measurement.fillRatio)).toFixed(4)),
    UNDERFILLED_PAGES_LT_60_PERCENT: measurements.filter((measurement) => measurement.fillRatio < 0.6).length,
    ...
    PROJECTED_BOOK_PAGES_TEXTUAL: bodyMean ? Number((MANUSCRIPT_TOTAL_WORDS / bodyMean).toFixed(2)) : null,
    PROJECTED_BOOK_PAGES_CURRENT: currentWordsPerPage ? Number((MANUSCRIPT_TOTAL_WORDS / currentWordsPerPage).toFixed(2)) : null,
    PROJECTED_BOOK_PAGES_DENSE: bodyMedian ? Number((MANUSCRIPT_TOTAL_WORDS / Math.max(250, bodyMedian)).toFixed(2)) : null,
...
async function main() {
  ...
  const baseProject = args.baseProject ?? (args.scope === "PARTES_I_IV" ? APPROVED_HISTORIA_PROJECT : args.scope === "COMPLETO" ? APPROVED_AGGREGATE_PROJECT : CANONICAL_PROJECT);
  ...
  if (!catalog.includes("## 28. Cobertura editorial capítulo a capítulo — REV1")) throw new Error("Catálogo REV1 §28 ausente");
  ...
  const annotatedBlocks = annotateHeadingPaths(parsed.blocks.map((source) => ({ ...source, scope: args.scope })));
  ...
  const sourceBlocks = bindSemanticAssets(
    args.scope === "PARTES_I_IV"
      ? annotatedBlocks.filter((source) => /^(?:PARTE II|PARTE III|PARTE IV)\b/u.test(source.sectionH1 ?? ""))
      : annotatedBlocks,
  );
  ...
  const historyPageHashBefore = isContinuation ? sha256(JSON.stringify(baseBook.pages.slice(0, preexistingPageCount))) : null;
  const assetHashes = await Promise.all(HISTORY_ASSETS.map(async (asset) => {
  ...
  try {
    const context = await browser.newContext({ viewport: { width: 1240, height: 1754 }, deviceScaleFactor: 1, reducedMotion: "reduce", locale: "pt-BR", timezoneId: "UTC", colorScheme: "light" });
    const browserPage = await context.newPage();
    await browserPage.addInitScript((key) => {
      const raw = localStorage.getItem(key);
      if (raw) window.__KALLISTIS_BOOK__ = JSON.parse(raw);
    }, MATERIALIZER_STORAGE_KEY);
    await browserPage.goto(`http://127.0.0.1:${PORT}/print`, { waitUntil: "domcontentloaded", timeout: 120000 });
    await browserPage.waitForSelector("html[data-print-ready='true']", { timeout: 120000 });
    await browserPage.addStyleTag({ content: ".k-print[data-pagination-measurer]{position:fixed;left:-100000px;top:0;visibility:hidden;pointer-events:none;}" });
    await browserPage.evaluate(() => document.querySelector(".k-print")?.setAttribute("data-pagination-measurer", "true"));
    generated = await materialize({ scope: args.scope, markdown, baseBook, browserPage, sourceBlocks });
    ...
    const roleForPart = (part) => {
      ...
      if (/^PARTE (V|VI)\b/u.test(part ?? "") || /^APÊNDICES\b/u.test(part ?? "")) return "PLAYER_REFERENCE";
      return undefined;
    };
    ...
    const continuationNodes = isContinuation
      ? continuationLabels.filter((label) => !existingNodeLabels.has(label)).map((label, index) => ({
        id: `node-${slug(label)}`,
        label,
    ...
    const mapSpreadAsset = HISTORY_ASSETS.find((asset) => asset.heading === "O Mapa em Duas Camadas");
    const preservedSpreads = (baseBook.spreads ?? []).map((spread) => spread.asset === mapSpreadAsset?.src
    ...
    const book = {
      ...
      nodes: isContinuation ? [...baseBook.nodes, ...continuationNodes] : [{ id: `node-${args.scope.toLowerCase()}`, label: args.scope, kind: args.scope === "HISTORIA" ? "part" : "chapter", pageIds: generated.pages.map((page) => page.id) }],
      pages: isContinuation ? [...structuredClone(baseBook.pages), ...continuationPages] : generated.pages,
      spreads: [...preservedSpreads, ...generatedSpreads],
    };
    const repairedOrphanHeadings = repairOrphanHeadings(book);
    const preexistingEditorialCorrections = isIntegral ? applyPreexistingEditorialCorrections(book) : 0;
    finalMeasurements = (await renderAndMeasure(browserPage, book), await browserPage.evaluate(() => [...document.querySelectorAll(".k-page")].map((root) => {
      const content = root.querySelector(".k-page__content") ?? root;
      const rect = content?.getBoundingClientRect();
      if (!content || !rect) return { overflow: true, fillRatio: 1, clientHeight: 0, tableRows: [] };
      const specialCopy = root.querySelector("[data-full-art-copy='true']");
      ...
      const used = blockInfo.reduce((max, element) => element.isImage ? max : Math.max(max, element.bottom), 0);
      const blockOutOfBounds = blockInfo.some((element) => !element.isImage && (element.top < -1 || element.bottom > rect.height + 1));
      return { overflow: blockOutOfBounds || (specialCopy
        ? (specialCopy.scrollHeight > specialCopy.clientHeight + 1 || specialCopy.scrollWidth > specialCopy.clientWidth + 1)
        : (!["part_opening", "full_art"].includes(root.dataset.template ?? "") && (content.scrollHeight > content.clientHeight + 1 || content.scrollWidth > content.clientWidth + 1))), fillRatio: content.clientHeight ? used / content.clientHeight : 0, usedHeight: used, clientHeight: content.clientHeight, clientWidth: content.clientWidth, scrollWidth: content.scrollWidth, blockInfo, tableRows: [...content.querySelectorAll("[data-table-row-id]")].map((row) => { const r = row.getBoundingClientRect(); return { top: r.top - rect.top, bottom: r.bottom - rect.top }; }) };
    })));
    finalMeasurements.forEach((measurement, index) => {
      const page = book.pages[index];
      if (page?.materialization && (!isContinuation || index >= baseBook.pages.length)) page.materialization.pageFillRatio = measurement.fillRatio;
    });
    const currentAssetHashes = await Promise.all(HISTORY_ASSETS.map(async (asset) => ({
      asset,
      currentSha: sha256(await readFile(path.join(ROOT, "public", asset.src.replace(/^\/+/, "")))),
    })));
    const invariants = validateMaterialization(book, sourceBlocks, originalHash, args.output, finalMeasurements, currentAssetHashes);
    const diagnostics = {
    ...
    if (isContinuation) {
      const historyPageHashAfter = sha256(JSON.stringify(book.pages.slice(0, preexistingPageCount).map((page, index) => {
      ...
      diagnostics.PREEXISTING_PAGES_PRESERVED = historyPageHashBefore === historyPageHashAfter ? `${preexistingPageCount}/${preexistingPageCount}` : "FAIL";
      diagnostics.PREEXISTING_PAGE_CONTENT_CHANGED = historyPageHashBefore === historyPageHashAfter ? 0 : 1;
      diagnostics.PREEXISTING_PAGE_LAYOUT_CHANGED = historyPageHashBefore === historyPageHashAfter ? 0 : 1;
      ...
      for (const part of continuationLabels) {
        ...
        diagnostics[`${part.replaceAll(" ", "_")}_WORDS`] = partSources.reduce((sum, source) => sum + source.wordCount, 0);
        diagnostics[`${part.replaceAll(" ", "_")}_PAGES`] = partPages.length;
        diagnostics[`${part.replaceAll(" ", "_")}_PAGES_WITH_IMAGES`] = partPages.filter((page) => page.blocks.some((block) => block.type === "image")).length;
      }
      diagnostics.PART_V_MATERIALIZED = continuationLabels.some((label) => /^PARTE V\b/u.test(label)) ? "YES" : "NO";
    }
    const compositionFamiliesUsed = Object.values(diagnostics.COMPOSITION_FAMILY_COUNTS).filter((count) => count > 0).length;
    const historyGatePassed = !isContinuation || (diagnostics.PREEXISTING_PAGES_PRESERVED === `${preexistingPageCount}/${preexistingPageCount}` && diagnostics.PREEXISTING_PAGE_CONTENT_CHANGED === 0 && diagnostics.PREEXISTING_PAGE_LAYOUT_CHANGED === 0);
    const visualGatePassed = diagnostics.INVALID_IMAGE_PLACEMENTS === 0 && compositionFamiliesUsed >= 3 && historyGatePassed;
    const warnings = [];
    if (book.pages.length > PAGINATION_POLICY.hardWarningBookPages) warnings.push("PAGE_COUNT_WARNING");
    if (book.pages.length > PAGINATION_POLICY.softMaximumBookPages) warnings.push("PAGE_COUNT_SOFT_MAXIMUM");
    if (diagnostics.PROJECTED_BOOK_PAGES_CURRENT > PAGINATION_POLICY.softMaximumBookPages) warnings.push("PROJECTED_BOOK_PAGES_WARNING");
    if (diagnostics.BODY_MAX_CONSECUTIVE_TEXT_PAGES > HARD_MAX_TEXT_RUN) warnings.push("BODY_IMAGE_CADENCE_SOFT_WARNING");
    ...
    if (compositionFamiliesUsed < 3) warnings.push("INSUFFICIENT_COMPOSITION_FAMILIES");
      ...
      ].some((key) => invariants[key] !== 0) || !visualGatePassed ? "FAIL" : "PASS",
      scope: args.scope,
      generatedAt: new Date().toISOString(),
      engine: { generatedBy: "kallistis-materializer", materializationVersion: VERSION, paginationPolicy: PAGINATION_POLICY, imageCadence: IMAGE_CADENCE, manuscriptTotalWords: MANUSCRIPT_TOTAL_WORDS, softMaxTextRun: SOFT_MAX_TEXT_RUN, hardMaxTextRun: HARD_MAX_TEXT_RUN },
      input: { manuscript: MANUSCRIPT, manuscriptSha256: sha256(normalizeLineEndings(markdown)), catalog: CATALOG, catalogSha256: sha256(catalog), sourceStartLine: parsed.selectedStartLine, sourceEndLine: parsed.selectedEndLine },
      output: { project: args.output, originalProject: baseProject, originalProjectSha256: originalHash },
      legacyReference: {
        project: CANONICAL_PROJECT,
        implementation: LEGACY_REFERENCE_SCRIPT,
        componentsReused: ["PageRenderer", "PartOpeningTemplate", "ChapterOpeningTemplate", "object-position/objectX", "140x210mm token grid"],
        componentsAdapted: ["image-top sizing", "image-side composition", "front matter dedication anchoring", "timeline milestone rhythm", "shared editorial image pair metadata"],
      },
      visualGate: { passed: visualGatePassed, semanticCorrectness: diagnostics.INVALID_IMAGE_PLACEMENTS === 0, compositionFamiliesUsed, minimumCompositionFamilies: 3, cadenceSoft: true, justification: null },
      warnings,
      diagnostics,
    };
    await writeFile(args.output, `${JSON.stringify(book, null, 2)}\n`, "utf8");
    await writeFile(args.output.replace(/\.json$/u, ".report.json"), `${JSON.stringify(report, null, 2)}\n`, "utf8");
    console.log(JSON.stringify({ ...report, output: report.output, diagnostics: report.diagnostics }, null, 2));
